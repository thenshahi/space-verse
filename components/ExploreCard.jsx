...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  ...
  >
    ...
    />
    {active !== id ? (
      <h3 className="font-semibold sm:text-[26px] text[18-px] text-white absolute z-0 lg:bottom-20 lg:rotate-[-90deg] lg:origin-[0,0]">
        {title}
      </h3>
    ) : (
      <div className="absolute bottom-0 p-8 flex justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        ...
        <p className="font-normal text-[16px] leading-[20px] text-white uppercase">Enter the SpaceVerse</p>
